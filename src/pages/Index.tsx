            ...
            {featured.map(s => {
              ...
              return (
                <div key={s.slug} className="rounded-lg border bg-card p-6 hover:border-[hsl(var(--cyan))] hover:shadow-elevated transition-all">
                  ...
                  <p className="text-2xl font-extrabold text-[hsl(var(--deep-blue))]">{s.startingPrice}<span className="text-xs font-normal text-muted-foreground">{s.slug === "domain-registration" ? "/yr" : "/mo"}</span></p>
